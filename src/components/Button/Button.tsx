...
export const Button = forwardRef(function ForwardedButton(
  ...
  return (
    <button
      ...
      {...props}
      ref={ref}
      className={classNames(className, "rounded-lg outline-none", {
        ...
        "text-white border border-primary-600 bg-primary-600":
          hierarchy == "primary",
        "hover:border-primary-700 hover:bg-primary-700": hierarchy == "primary",
        "focus:ring-4 focus:ring-primary-100":
          hierarchy == "primary" || hierarchy == "secondary",
        "aria-disabled:border-primary-200 aria-disabled:bg-primary-200 aria-disabled:cursor-not-allowed":
          hierarchy == "primary",
        ...
        "hover:border-primary-100 hover:bg-primary-100":
          hierarchy == "secondary",
        "aria-disabled:text-primary-300 aria-disabled:border-primary-25 aria-disabled:bg-primary-25 aria-disabled:cursor-not-allowed":
          hierarchy == "secondary",
      })}
      onClick={handleClick}
    />
